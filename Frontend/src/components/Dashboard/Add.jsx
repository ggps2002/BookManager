            ...
            <form onSubmit={handleSubmit}>
                <div className='md:p-10 xs:p-3 w-full'>
                    <div className='my-7'>
                        ...
                        <input
                            className='mt-2 md:w-[85%] xs:w-full h-10 indent-3'
                            type="text"
                    ...
                    <div className='my-7'>
                        ...
                        <input
                            className='mt-2 md:w-[85%] xs:w-full h-10 indent-3'
                            type="text"
                            placeholder='Write a few lines describing the book'
                            name='brief'
                            onChange={handleChange}
                            value={details.brief}
                        />
                    ...
                    <div className='my-7'>
                        <label htmlFor="Summary">Summary (Maintain the HTML tags)</label><br />
                        <ReactQuill
                            className='mt-2 md:w-[85%] xs:w-full indent-3 p-2'
